...
@Component({
  selector: 'app-oslo-bike-map',
  templateUrl: './oslo-bike-map.component.html',
  styleUrls: ['./oslo-bike-map.component.scss']
})
export class OsloBikeMapComponent implements OnInit, OnChanges {
