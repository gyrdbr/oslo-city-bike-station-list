...
const bysykkelServiceSpy = jasmine.createSpyObj('BysykkelService', ['getCombinedBikesAndStatus']);
...
describe('BikesiteListComponent', () => {
  ...
  bysykkelServiceSpy.getCombinedBikesAndStatus.and.returnValue(of(mockRes));
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
        ...
        providers: [
          {
            provide: BysykkelService,
            useValue: bysykkelServiceSpy
          }
        ]
    })
    .compileComponents();
